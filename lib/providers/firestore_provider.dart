...
//  Firestore _firestore = Firestore.instance;
  ...
  Future<Quiz> getQuizById(String id) async {
    DocumentSnapshot doc = await Firestore.instance.collection(COLLECTION_QUIZ).document(id).get();
    return Quiz.fromFirestore(doc);

//    return _firestore.collection(COLLECTION_QUIZ).document(id).snapshots();
  }
