...
class QuizRepository {
  ...
  static final Problem problem2 = Problem(first: 2, second: 2, operator: Operators.ADD);
  static final Problem problem3 = Problem(first: 3, second: 2, operator: Operators.SUBTRACT);
  static final Problem problem4 = Problem(first: 4, second: 2, operator: Operators.MULTIPLY);
